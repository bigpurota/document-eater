...
def _with_roles(document: Document) -> Document:
    ...
    for page in document.pages:
        ...
        for block in page.blocks:
            ...
            role = "heading" if short and (larger or numbered) else "body"
...
def build_graph(document: Document) -> tuple[Document, DocumentGraph]:
    ...
    nodes = [GraphNode(document.id, "document", {"filename": document.filename})]
    ...
    for page in document.pages:
        ...
        nodes.append(GraphNode(page_id, "page", {"number": page.number, "source": page.source}))
